...
A code indexing and semantic search VSCode extension powered by [Claude Context](https://github.com/danielbowne/claude-context).

> 📖 **New to Claude Context?** Check out the [main project README](https://github.com/danielbowne/claude-context/blob/master/README.md) for an overview and setup instructions.
...
![](https://raw.githubusercontent.com/danielbowne/claude-context/master/assets/signup_and_create_cluster.jpeg)
...
![Zilliz Cloud Dashboard](https://raw.githubusercontent.com/danielbowne/claude-context/master/assets/zilliz_cloud_dashboard.jpeg)
...
- [Main Contributing Guide](https://github.com/danielbowne/claude-context/blob/master/CONTRIBUTING.md) - General contribution guidelines
- [VSCode Extension Contributing](https://github.com/danielbowne/claude-context/blob/master/packages/vscode-extension/CONTRIBUTING.md) - Specific development guide for this extension

## Related Packages

- **[@dannyboy2042/claude-context-core](https://github.com/danielbowne/claude-context/tree/master/packages/core)** - Core indexing engine used by this extension
- **[@dannyboy2042/claude-context-mcp](https://github.com/danielbowne/claude-context/tree/master/packages/mcp)** - Alternative MCP server integration
...
MIT - See [LICENSE](https://github.com/danielbowne/claude-context/blob/master/LICENSE) for details 